...
module.exports = {
  ...
  plugins: [
    ...
    new CopyWebpackPlugin([{ from: "./src/js/ai-matching.js", to: "js/ai-matching.js" }]),
    new CopyWebpackPlugin([{ from: "./src/random_forest_model.json", to: "random_forest_model.json" }]),
    new CopyWebpackPlugin([{ from: "./ORGANDONATIONBLOCK.csv", to: "transplant_dataa.csv" }]),
